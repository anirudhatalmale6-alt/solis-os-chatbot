const translations = {
  en: {
    ...
    pricing: (name) => `Simple pricing, ${name}:\n\nSolis OS - $39 AUD/month\nEverything included: bookings, WhatsApp AI, CRM, invoicing, analytics, marketing.\n14-day free trial, no credit card.\n\nSolis OS POS - $239 AUD/year\nFull point-of-sale system: inventory, barcode scanning, remote management from phone, reports, promotions, multi-staff.\n10-day free trial, no credit card.\n\nReady to get started? Visit https://app.solis-os.com/signup\nTry POS free: https://solis-os.com/app/`,
    ...
    pos: (name) => `Great question, ${name}! Solis OS POS is our full point-of-sale system.\n\nKey features:\n\nRemote Management - Control your entire shop from your phone. Add products, adjust stock, create promotions, track sales from anywhere.\n\nBarcode Scanning - Use your camera or any USB/Bluetooth scanner for instant product lookup.\n\nInventory Management - Real-time stock tracking with low stock alerts.\n\nSales Reports - Daily, weekly, monthly reports. Know your top products and peak hours.\n\nPromotions Engine - BOGO deals, percentage off, fixed discounts. Auto-applied at checkout.\n\nMulti-Staff - PIN-based login with permissions for cashiers vs managers.\n\nLoyalty Program - Barcode loyalty cards your customers can carry.\n\nWorks Offline - No internet needed. Sales sync when you reconnect.\n\nPricing: $239 AUD/year. Everything included, no tiers.\n\n10-day free trial, no credit card required.\n\nTry it now: https://solis-os.com/app/\nLearn more: https://solis-os.com/pos.html`,
